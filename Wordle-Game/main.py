...
class Wordle:
    ...
    def __init__(self):
        ...
        self.root.wm_iconbitmap('Wordle-Game/images/icon.ico')
        ...
        self.setting = Image.open('Wordle-Game/images/setting.png')
        self.setting = self.setting.resize((40, 40), Image.Resampling.LANCZOS)
        self.setting = ImageTk.PhotoImage(self.setting)

        self.setting_dark = Image.open('Wordle-Game/images/setting_dark.png')
        ...
        label = Image.open('Wordle-Game/images/HEAD.png')
    ...
    def show_popup(self):
        ...
        popup.wm_iconbitmap('Wordle-Game/images/icon.ico')
        popup.focus_force()
    ...
    def get_from_db(self):
        if not os.path.exists("settings.db"):
            ...
            self.word_api = words_api.Words(5)
            connection.commit()
            connection.close()
        else:
            connection = sqlite3.connect("settings.db")
