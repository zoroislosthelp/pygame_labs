...
class Settings:
    ...
    def __init__(self, functions):
        ...
        self.window.wm_iconbitmap('Wordle-Game/images/icon.ico')
        ...
        increase = Image.open("Wordle-Game/images/increase.png")
        increase = increase.resize((40, 40), Image.Resampling.LANCZOS)
        increase = ImageTk.PhotoImage(increase)

        decrease = Image.open("Wordle-Game/images/decrease.png")
